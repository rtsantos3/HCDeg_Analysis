...
change_distance_matrix_names <- function(old_names, new_names, distance_matrix) {
  new_names <- new_names[old_names]
  rownames(distance_matrix) <- new_names
  colnames(distance_matrix) <- new_names
  return(distance_matrix)
}

#First load the distance matrices from the bray-curtis plot
bray_curtis_matrix <- read_qza(file='../diversity/bray_curtis_distance_matrix.qza')$data
jacc_matrix <- read_qza(file='../diversity/jaccard_distance_matrix.qza')$data
